        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card h-100 bg-dark-accent text-light shadow-sm border-0">
            ...
            <div class="card-footer bg-transparent border-0">
              ...
              <button type="button" onclick="agregarAlCarrito(<?= $producto->getIdProducto(); ?>, '<?= htmlspecialchars(addslashes($producto->getNombre())); ?>', <?= $producto->getPrecio(); ?>, '<?= htmlspecialchars($producto->getFoto()); ?>')" class="btn btn-accent w-100 text-dark btn-success">
